...
pub struct OciLedgerPreflightReport {
    ...
    pub rows_with_provider_visible_trace_key: u64,
...
pub struct OciSendLedgerPrepareReport {
    ...
    pub message_id_trace_rows: u64,
    pub correlation_id_trace_rows: u64,
    pub header_value_trace_rows: u64,
    pub provider_visible_trace_candidate_rows: u64,
    pub local_correlation_only_rows: u64,
...
impl OciLedgerPreflightReport {
    pub fn skipped(required: bool, configured: bool, note: &str) -> Self {
        Self {
            ...
            rows_with_provider_visible_trace_key: 0,
...
impl OciSendLedgerPrepareReport {
    pub fn fixture() -> Self {
        Self {
            ...
            message_id_trace_rows: 1,
            correlation_id_trace_rows: 0,
            header_value_trace_rows: 0,
            provider_visible_trace_candidate_rows: 1,
            local_correlation_only_rows: 0,
